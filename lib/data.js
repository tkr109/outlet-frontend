...
export const menu = [
  {
    ...
    items: [
      ...
      { id: 'tachini', name: 'Tachini', greek: 'Ταχίνι', price: 1.0, note: 'Authentic dip.', image: 'https://images.unsplash.com/photo-1604152135912-04a022e23696?q=80&w=2000&auto=format&fit=crop' },
      { id: 'tirokafteri', name: 'Tirokafteri', greek: 'Τυροκαφτερή', price: 1.0, note: 'Spicy cheese dip.', image: 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?q=80&w=2000&auto=format&fit=crop' },
      { id: 'tzatziki', name: 'Tzatziki', greek: 'Τζατζίκι', price: 1.0, note: 'Cool yogurt dip.', image: 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?q=80&w=2000&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'portion-mixed-doner', name: 'Mixed Doner', greek: 'Γύρος Μιξ', price: 10.0, note: 'With chips & salad.', image: 'https://images.unsplash.com/photo-1561651188-d207bbec4ec3?q=80&w=2000&auto=format&fit=crop' },
      ...
      { id: 'portion-halloumi', name: 'Halloumi Portion', greek: 'Χαλλούμι μερίδα', price: 12.0, note: 'With chips & salad.', image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?q=80&w=2000&auto=format&fit=crop' },
