...
export const menu = [
  {
    ...
    items: [
      ...
      { id: 'coleslaw', name: 'Coleslaw', price: 3.0, note: 'Classic cream.', image: 'https://images.unsplash.com/photo-1625938145744-533e82abce26?q=80&w=2000&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'vegie-burger', name: 'Vegie Burger', price: 6.0, note: 'Plant-based patty', image: 'https://images.unsplash.com/photo-1520072959219-c595e6cdc381?q=80&w=2000&auto=format&fit=crop' },
    ],
  },
  {
    category: 'Sandwiches',
    ...
    items: [
      ...
      { id: 'sandwich-chips', name: 'Sandwich & Chips', price: 6.0, note: 'With a side of chips.', image: 'https://images.unsplash.com/photo-1481070555726-e2fe8357b3e3?q=80&w=2000&auto=format&fit=crop' },
      { id: 'hot-dog', name: 'Hot Dog', greek: 'Χοτ Ντόγκ', price: 3.5, note: 'Classic style.', image: 'https://images.unsplash.com/photo-1612392062126-21009e3a37a1?q=80&w=2000&auto=format&fit=crop' },
      { id: 'hot-dog-chips', name: 'Hot Dog & Chips', price: 4.5, note: 'With a side of chips.', image: 'https://images.unsplash.com/photo-1612392062126-21009e3a37a1?q=80&w=2000&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'portion-halloumi', name: 'Halloumi Portion', greek: 'Χαλλούμι μερίδα', price: 12.0, note: 'With chips & salad.', image: 'https://images.unsplash.com/photo-1530016555861-3bbd58d36efb?q=80&w=2000&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      { id: 'souv-pork-kebab', name: 'Pork Kebab', greek: 'Σουβλάκι Χοιρινό', price: 6.0, image: 'https://images.unsplash.com/photo-1615967912423-edfa7a0bdf81?q=80&w=2000&auto=format&fit=crop' },
      ...
      { id: 'souv-falafel', name: 'Falafel', greek: 'Φαλάφελ', price: 6.0, image: 'https://images.unsplash.com/photo-1593001874117-c99c800e3eb6?q=80&w=2000&auto=format&fit=crop' },
      ...
      { id: 'souv-halloumi', name: 'Halloumi', greek: 'Χαλλούμι', price: 7.0, image: 'https://images.unsplash.com/photo-1530016555861-3bbd58d36efb?q=80&w=2000&auto=format&fit=crop' },
    ],
  },
  {
    category: 'Drinks',
