...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 sm:bottom-6 left-0 right-0 z-50 flex justify-center">
      <div className="bg-zinc-900/80 backdrop-blur-2xl shadow-2xl shadow-orange-500/10 w-[90%] max-w-md rounded-full px-6 py-3 sm:px-8 flex justify-around items-center">
